...
describe('Listings Resolvers', () => {
    ...
    it('should set pricing', async () => {
        ...
        const result = await mockDL.setPricing('listing-1', { amount: 6000, currency: 'RUB' }, 2, 14);
        expect(result).toEqual(mockListing);
        expect(mockDL.setPricing).toHaveBeenCalledWith('listing-1', { amount: 6000, currency: 'RUB' }, 2, 14);
    });
