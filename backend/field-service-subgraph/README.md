...
Подграф для управления полевыми услугами (уборки и ремонты) в системе Posutka.

## Описание

Field Service Subgraph отвечает за:

- **Управление уборщиками** - создание и управление профилями уборщиков
- **Управление мастерами** - создание и управление профилями мастеров для ремонтов
...
- **Планирование ремонтов** - создание и назначение ремонтов мастерам
- **Документация уборок** - формирование документов приемки и сдачи квартир с фотографиями
- **Чек-листы** - универсальная система чек-листов для уборок и ремонтов
...
### Master (Мастер)
Представляет мастера для выполнения ремонтов. Может быть INTERNAL (сотрудник с User) или EXTERNAL (подрядчик без User).

### Repair (Ремонт)
Процесс выполнения ремонта в квартире. Аналогичен Cleaning, но для ремонтных работ. Имеет статусы: PLANNED, IN_PROGRESS, COMPLETED, CANCELLED.
