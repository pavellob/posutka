...
const examples = [
  {
    title: 'Моментальная публикация',
    description:
      'Добавили новый объект в Property — Channel Manager сразу создаёт listing на Airbnb и Booking.com с автоматической синхронизацией.',
    icon: '🚀',
  ...
  },
  {
    title: 'Единые тарифы',
    description:
      'Изменили цену на 10% — во всех каналах обновилось автоматически. Никаких ручных правок в разрозненных кабинетах.',
    icon: '💰',
    runtime: { minutes: 1, seconds: 30 },
  },
  {
    title: 'Синк календарей',
    description:
      'Бронь из Booking.com импортируется в систему, чтобы избежать овербукинга. Единый календарь для всех площадок.',
    icon: '📅',
  ...
  },
  {
    ...
    description:
      'Загрузили фото и описание — они транслируются на все площадки с учётом форматов и требований каждого канала.',
    icon: '🖼',
        ...
        <SectionHeading number="2" id="examples-title">
          Примеры из практики
                ...
                <p className="mt-8 font-display text-4xl font-bold tracking-tight text-slate-900">
                  Реальные кейсы управления каналами
                </p>
        <p className="mt-4 text-lg tracking-tight text-slate-700">
          Посмотрите, как домен «Placement» решает конкретные задачи управления каналами 
          и делает размещение объектов простым и эффективным.
        </p>
      </Container>
