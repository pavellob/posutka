...
import iamHeroImage from '@/images/iam-hero.svg'
  ...
  return (
    <figure className="relative mx-auto max-w-md text-center lg:mx-0 lg:text-left">
      ...
      <figcaption className="mt-2 text-sm text-slate-500">
        ...
        , IT-директор сети отелей (120 номеров)
      </figcaption>
    </figure>
  )
}
        ...
        <div className="relative flex items-end lg:col-span-5 lg:row-span-2">
          ...
          <div className="relative z-10 mx-auto flex w-64 rounded-xl shadow-xl md:w-80 lg:w-auto">
            <Image 
              ...
              src={iamHeroImage} 
              alt="Кто есть кто - IAM система управления пользователями и доступами" 
              priority 
            />
          </div>
        </div>
        ...
        <div className="bg-white pt-16 lg:col-span-7 lg:bg-transparent lg:pt-0 lg:pl-16 xl:pl-20">
          <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
            ...
            <p className="mt-4 text-3xl text-slate-600">
              IAM система управления пользователями, ролями и доступами для недвижимости
            </p>
