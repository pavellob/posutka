...
import operationsHeroImage from '@/images/operations-hero.svg'
        ...
        <div className="relative flex items-end lg:col-span-5 lg:row-span-2">
          ...
          <div className="relative z-10 mx-auto flex w-64 rounded-xl shadow-xl md:w-80 lg:w-auto">
            <Image 
              ...
              alt="Операции и обслуживание - уборка, ремонт, управление недвижимостью" 
              priority 
            />
          </div>
        </div>
        ...
        <div className="bg-white pt-16 lg:col-span-7 lg:bg-transparent lg:pt-0 lg:pl-16 xl:pl-20">
          <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
            <h1 className="font-display text-5xl font-extrabold text-slate-900 sm:text-6xl">
              Домен «Операции и обслуживание»
            </h1>
            <p className="mt-4 text-3xl text-slate-600">
              Комплексная система автоматизации всех операционных процессов в посуточной аренде
            </p>
