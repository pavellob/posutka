...
import { UnifiedGraphManagerOptions, UnifiedGraphPlugin, Instrumentation as Instrumentation$2, Transports, TransportEntryAdditions, BatchDelegateOptions, OnSubgraphExecuteHook } from '@graphql-mesh/fusion-runtime';
...
interface PropagateHeadersOpts<TContext extends Record<string, any>> {
    fromClientToSubgraphs?: (payload: FromClientToSubgraphsPayload<TContext>) => Record<string, string | null | undefined> | void | Promise<Record<string, string | null | undefined> | void>;
    fromSubgraphsToClient?: (payload: FromSubgraphsToClientPayload<TContext>) => Record<string, string | string[] | null | undefined> | void | Promise<Record<string, string | string[] | null | undefined> | void>;
}
declare function usePropagateHeaders<TContext extends Record<string, any>>(opts: PropagateHeadersOpts<TContext>): GatewayPlugin<TContext>;
...
declare const RETRY_SYMBOL: unique symbol;
...
declare function isRetryExecutionRequest(executionRequest?: ExecutionRequest): executionRequest is RetryExecutionRequest;
declare function getRetryInfo(executionRequest: RetryExecutionRequest): RetryInfo;
...
interface GatewayHivePersistedDocumentsOptions {
     ...
     */
    allowArbitraryOperations?: boolean | ((request: Request) => MaybePromise<boolean>);
}
interface GatewayConfigBase<TContext extends Record<string, any>> {
    ...
    persistedDocuments?: GatewayHivePersistedDocumentsOptions | (Omit<UsePersistedOperationsOptions<GatewayContext>, 'allowArbitraryOperations'> & {
        /**
         * Whether arbitrary documents should be allowed along-side persisted documents.
         *
         * Alternatively, you can provide a function that returns a boolean value based on
     ...
     */
    genericAuth?: GenericAuthPluginOptions<Record<string, any>, // convenient for strict tsconfig environment
    // convenient for strict tsconfig environment
...
declare function createLoggerFromLogging(logging: boolean | Logger | LogLevel | undefined): Logger;
