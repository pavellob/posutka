...
export function importFederationDirectives(subgraph, directives) {
    const schemaDirectives = getDirectiveExtensions(subgraph);
    const linkDirectives = (schemaDirectives.link ||= []);
...
export function importMeshDirectives(subgraph, directives) {
    const schemaDirectives = getDirectiveExtensions(subgraph) || {};
    const linkDirectives = (schemaDirectives.link ||= []);
...
export function normalizeDirectiveExtensions(subgraph) {
...
export function convertSubgraphToFederationv2(subgraph) {
    const schemaDirectives = getDirectiveExtensions(subgraph);
