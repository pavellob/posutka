...
declare const _default: {
    getSubgraphExecutor({ transportEntry, log: rootLog }: _graphql_mesh_transport_common.TransportGetSubgraphExecutorOptions<WSTransportOptions>, onClient?: (client: Client) => void): DisposableExecutor & AsyncDisposable;
};
