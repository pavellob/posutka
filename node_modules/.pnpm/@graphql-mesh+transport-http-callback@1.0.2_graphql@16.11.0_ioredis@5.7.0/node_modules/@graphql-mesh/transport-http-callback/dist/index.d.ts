...
declare const _default: {
    getSubgraphExecutor({ transportEntry, fetch, pubsub, log: rootLog, }: _graphql_mesh_transport_common.TransportGetSubgraphExecutorOptions<HTTPCallbackTransportOptions>): DisposableExecutor;
};
