...
import { getNamedType, isEnumType, isSpecifiedScalarType, } from 'graphql';
...
export function createNamingConventionTransform(config) {
    const typeNamesFn = typeof config.typeNames === 'string' ? NamingConventionMap[config.typeNames] : config.typeNames;
