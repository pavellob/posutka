-- CreateEnum
CREATE TYPE "EventType" AS ENUM ('CLEANING_SCHEDULED', 'CLEANING_ASSIGNED', 'CLEANING_STARTED', 'CLEANING_COMPLETED', 'CLEANING_CANCELLED', 'BOOKING_CREATED', 'BOOKING_CONFIRMED', 'BOOKING_CANCELLED', 'BOOKING_CHECKIN', 'BOOKING_CHECKOUT', 'TASK_CREATED', 'TASK_ASSIGNED', 'TASK_STATUS_CHANGED', 'TASK_COMPLETED', 'USER_CREATED', 'USER_UPDATED', 'USER_LOCKED', 'USER_UNLOCKED', 'ORG_CREATED', 'ORG_UPDATED', 'MEMBER_ADDED', 'MEMBER_REMOVED');
...
VALUES 
  ...
  (
    ...
    'NOTIFICATION',
    ARRAY['CLEANING_SCHEDULED', 'CLEANING_ASSIGNED', 'CLEANING_STARTED', 'CLEANING_COMPLETED', 'CLEANING_CANCELLED']::text[],
    true,
    NOW(),
    NOW()
  ),
  ...
  (
    ...
    'AUDIT',
    ARRAY[
      'CLEANING_SCHEDULED', 'CLEANING_ASSIGNED', 'CLEANING_STARTED', 'CLEANING_COMPLETED', 'CLEANING_CANCELLED',
