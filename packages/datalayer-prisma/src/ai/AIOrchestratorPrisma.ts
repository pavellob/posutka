...
export class AIOrchestratorPrisma implements IAIOrchestrator {
  constructor(private readonly prisma: PrismaClient) {}

  async run(orgId: string, command: string, context?: unknown): Promise<AICommandResult> {
    try {
  ...
  private async handleCreateBooking(orgId: string, command: string, context?: unknown): Promise<AICommandResult> {
  ...
  private async handleShowBookings(orgId: string, command: string, context?: unknown): Promise<AICommandResult> {
  ...
  private async handleCreateInvoice(orgId: string, command: string, context?: unknown): Promise<AICommandResult> {
  ...
  private async handleShowStats(orgId: string, command: string, context?: unknown): Promise<AICommandResult> {
