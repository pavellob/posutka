import type { UUID, Money, Listing, DiscountRule } from './types.js';
...
export interface IListingsDL {
    getListingById(id: UUID): Promise<(Listing & {
        discounts: DiscountRule[];
    }) | null>;
    listListings(unitId: UUID, first?: number, after?: string): Promise<{
        edges: Listing[];
        endCursor?: string;
        hasNextPage: boolean;
    }>;
